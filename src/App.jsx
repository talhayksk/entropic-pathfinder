            ...
            <div className="flex items-center justify-between bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-xl px-5 py-3 mb-6">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 disabled:text-gray-500 text-white rounded-lg font-medium transition-colors shadow-lg shadow-gray-900/20 text-sm flex items-center gap-2"
                >
